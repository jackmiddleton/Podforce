...
task2 = Task.create!({contact: contact2, user: user1, description: "See the reviews", priority: "low", date_time: DateTime.new(2022,2,3), ownership: "You", complete: "No", category: "Reviews"})
